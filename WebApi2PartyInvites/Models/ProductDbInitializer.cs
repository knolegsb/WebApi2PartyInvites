...
namespace WebApi2PartyInvites.Models
{
    public class ProductDbInitializer : DropCreateDatabaseAlways<ProductDbContext>
    {
        protected override void Seed(ProductDbContext context)
        {
            ...
            new List<Order>
            {
                new Order()
                {
                    Customer = "Alice Smith", TotalCost = 68.45m, Lines = new List<OrderLine>
                    {
                ...
                new Order()
                {
                    Customer = "Peter Jones", TotalCost = 79791m, Lines = new List<OrderLine>
                    {
